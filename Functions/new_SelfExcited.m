function new_SelfExcited()
    % Creates a model for the self-excited forces
    flags.Exit = 0;
    props = struct;
    ...
    while not(flags.Exit)
        ...
        switch flags.mainMenu
            case 1
                ...
                dispHeader()
                disp('Choose one of the following options:');
                disp('   #1 Use analytical data (Theodorsen Circulation)');
                ...
                switch flags.datasetChoice
                    case 1
                        ...
                        props = setSEWindProps(props);
                        [data, props] = getSEIOPairs(props);
